...
function App() {
  ...
  var _useState5 = (0,react.useState)(0),
    ...
    mapOffset = _useState6[0],
    setMapOffset = _useState6[1];
  var preloadImage = function preloadImage(imageUrl) {
    var img = new Image();
    img.src = imageUrl;
  };
  ...
  (0,react.useEffect)(function () {
    var _mapContRef$current, _mapContRef$current2, _mapRef$current;
    // const mapContTop = mapContRef.current?.getBoundingClientRect().top || window.innerHeight;
    var mapContY = ((_mapContRef$current = mapContRef.current) === null || _mapContRef$current === void 0 ? void 0 : _mapContRef$current.getBoundingClientRect().y) || window.innerHeight;
    var mapContHeight = ((_mapContRef$current2 = mapContRef.current) === null || _mapContRef$current2 === void 0 ? void 0 : _mapContRef$current2.getBoundingClientRect().height) || 0;
    var mapHeight = ((_mapRef$current = mapRef.current) === null || _mapRef$current === void 0 ? void 0 : _mapRef$current.getBoundingClientRect().height) || 0;
    console.log("scroll postion: ".concat(offset));
    console.log("kartan alku: ".concat(window.pageYOffset + mapContY));
    console.log("kartan loppu: ".concat(window.pageYOffset + mapContY + mapContHeight));
    if (mapRef.current) {
      if (offset < window.pageYOffset + mapContY) {
        var _mapRef$current2, _mapRef$current3;
        // Beginning
        console.log('Beginning');
        (_mapRef$current2 = mapRef.current) === null || _mapRef$current2 === void 0 ? void 0 : _mapRef$current2.classList.add('absolute');
        (_mapRef$current3 = mapRef.current) === null || _mapRef$current3 === void 0 ? void 0 : _mapRef$current3.classList.remove('fixed');
        setMapOffset(0);
      } else if (offset > window.pageYOffset + mapContY + mapContHeight - mapHeight) {
        // End
        console.log('End');
