...
function App() {
  ...
  var preloadImage = function preloadImage(im_url) {
    var img = new Image();
    img.src = im_url;
  };
  ...
  (0,react.useEffect)(function () {
    var _mapContRef$current, _mapContRef$current2, _mapContRef$current3;
    ...
    var mapContY = ((_mapContRef$current3 = mapContRef.current) === null || _mapContRef$current3 === void 0 ? void 0 : _mapContRef$current3.getBoundingClientRect().y) || 0;
  ...
  var changeVisible = function changeVisible(i) {
    mapRef.current.classList.value = "map page".concat(i);
  };
