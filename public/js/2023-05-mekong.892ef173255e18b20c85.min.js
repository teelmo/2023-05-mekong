...
function App() {
  ...
  (0,react.useEffect)(function () {
    ...
    var mapContTop = ((_mapContRef$current = mapContRef.current) === null || _mapContRef$current === void 0 ? void 0 : _mapContRef$current.getBoundingClientRect().top) || window.innerHeight;
